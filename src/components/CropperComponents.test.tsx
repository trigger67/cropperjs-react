...
describe('CropperCanvas', () => {
    ...
    it('sets props as properties', async () => {
        ...
        const element = container.querySelector('cropper-canvas') as any;
...
describe('CropperSelection', () => {
    ...
    it('sets props as properties', async () => {
        ...
        const element = container.querySelector('cropper-selection') as any;
        // Wait for useEffect to run
        await new Promise(resolve => setTimeout(resolve, 0));
...
describe('CropperImage', () => {
    ...
    it('sets props as properties', async () => {
        ...
        const element = container.querySelector('cropper-image') as any;
        // Wait for useEffect to run
        await new Promise(resolve => setTimeout(resolve, 0));
